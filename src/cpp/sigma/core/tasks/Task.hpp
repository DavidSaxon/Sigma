...
public:
     ...
     *
     * \throws arc::ex::ValueError If the ``parent`` parameter is null, or the
     *                               ``title`` parameter is empty.
     */
    Task(Task* parent, const arc::str::UTF8String& title);
     ...
     *
     * \throws arc::ex::ValueError If the ``other`` parameter is a RootTask.
     */
     ...
     *
     * \throws arc::ex::ValueError If ``parent`` is null. // TODO: REMOVE ME
     * \throws arc::ex::IllegalActionError If the given parent is already a
     ...
     *          as child Tasks.
     *
     * \throws arc::ex::IllegalActionError If the Task to add as a child is
     ...
     */
    const arc::str::UTF8String& get_title() const;

    /*!
     * \brief Sets the title string of this Task.
     */
    virtual void set_title(const arc::str::UTF8String& title);
     ...
     * - ``const arc::str::UTF8String&`` - the previous title of the Task.
     * - ``const arc::str::UTF8String&`` - the new title of the Task.
     */
...
protected:
     ...
     * \param title The title of the task.
     */
    Task(const arc::str::UTF8String& title);
...
private:
    ...
    sigma::core::CallbackHandler<
            Task*,
            const arc::str::UTF8String&,
            const arc::str::UTF8String&> m_title_changed_callback;
     ...
     */
    void set_title_internal(const arc::str::UTF8String& title);
