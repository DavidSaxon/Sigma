 ...
 * \author David Saxon
 */
#ifndef ARCANECORE_TEST_LOGFORMATTER_PLAINTESTLOGFORMATTER_HPP_
#define ARCANECORE_TEST_LOGFORMATTER_PLAINTESTLOGFORMATTER_HPP_
...
public:
     ...
     */
    PlainTestLogFormatter(arc::uint16 verbosity, std::ostream* stream);
