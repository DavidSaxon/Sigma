 ...
 * \author David Saxon
 */
#ifndef ARCANECORE_TEST_LOGFORMATTER_XMLLOGFORMATTER_HPP_
#define ARCANECORE_TEST_LOGFORMATTER_XMLLOGFORMATTER_HPP_
...
public:
     ...
     */
    XMLTestLogFormatter(arc::uint16 verbosity, std::ostream* stream);
